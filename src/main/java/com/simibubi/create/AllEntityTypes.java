...
public class AllEntityTypes {
	...
	public static EntityType<Entity> SUPER_GLUE;
	...
	public static void register() {
		...
		SUPER_GLUE = Registry.register(Registry.ENTITY_TYPE, new Identifier(Create.ID, "super_glue"),
			FabricEntityTypeBuilder.create(SpawnGroup.MISC, SuperGlueEntity::new)
				.trackRangeBlocks(10).trackedUpdateRate(Integer.MAX_VALUE).forceTrackedVelocityUpdates(false).fireImmune().build());
	}
