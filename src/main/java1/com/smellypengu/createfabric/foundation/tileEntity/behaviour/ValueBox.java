...
import com.smellypengu.createfabric.foundation.utility.outliner.ChasingAABBOutline;
...
public class ValueBox extends ChasingAABBOutline {
	...
	public static class IconValueBox extends ValueBox {
		...
		public IconValueBox(String label, INamedIconOptions iconValue, Box bb, BlockPos pos) {
			super(label, bb, pos);
