...
import com.smellypengu.createfabric.content.contraptions.components.structureMovement.AbstractContraptionEntity;
import com.smellypengu.createfabric.content.contraptions.components.structureMovement.Contraption;
import com.smellypengu.createfabric.content.contraptions.components.structureMovement.MovementBehaviour;
import com.smellypengu.createfabric.content.contraptions.components.structureMovement.MovementContext;
import com.smellypengu.createfabric.foundation.render.*;
...
public class ContraptionRenderDispatcher {
    ...
    public static BufferBuilder buildStructure(Contraption c, RenderLayer layer) {
        if (renderWorld == null || renderWorld.world != MinecraftClient.getInstance().world)
        ...
        builder.end(); // TODO end INSTEAD OF finishDrawing COULD BE WRONG
        renderWorld.clear();
        renderWorld = null;
        return builder;
    }
