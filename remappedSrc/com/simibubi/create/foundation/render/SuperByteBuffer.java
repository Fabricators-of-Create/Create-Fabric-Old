...
public class SuperByteBuffer extends TemplateBuffer {
	...
	net.minecraft.util.math.Vector4f pos = new net.minecraft.util.math.Vector4f();
	Vector3f normal = new Vector3f();
	net.minecraft.util.math.Vector4f lightPos = new net.minecraft.util.math.Vector4f();
	...
	private static int getLight(World world, net.minecraft.util.math.Vector4f lightPos) {
