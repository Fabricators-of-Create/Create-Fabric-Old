...
public class BasinRenderer extends SmartTileEntityRenderer<BasinTileEntity> {
	...
	@Override
	protected void renderSafe(BasinTileEntity basin, float partialTicks, MatrixStack ms, VertexConsumerProvider buffer,
	...
	protected void renderItem(MatrixStack ms, VertexConsumerProvider buffer, int light, int overlay, ItemStack stack) {
		MinecraftClient.getInstance()
			.getItemRenderer()
			.renderItem(stack, Mode.GROUND, light, overlay, ms, buffer);
	}

	protected float renderFluids(BasinTileEntity basin, float partialTicks, MatrixStack ms, VertexConsumerProvider buffer,
		int light, int overlay) {
