...
public class ShadowRenderHelper {
	...
	public static void renderShadow(MatrixStack p_229096_0_, VertexConsumerProvider p_229096_1_, Vec3d pos,
		...
		for (BlockPos blockpos : BlockPos.iterate(new BlockPos(i, k, i1), new BlockPos(j, l, j1))) {
			renderShadowPart(matrixstack$entry, ivertexbuilder, MinecraftClient.getInstance().world, blockpos, d2, d0, d1, f, p_229096_3_);
		}

	}

	private static void renderShadowPart(MatrixStack.Entry p_229092_0_, VertexConsumer p_229092_1_,
			WorldView p_229092_2_, BlockPos p_229092_3_, double p_229092_4_, double p_229092_6_, double p_229092_8_,
		...
		if (blockstate.getRenderType() != BlockRenderType.INVISIBLE && p_229092_2_.getLightLevel(p_229092_3_) > 3) {
			if (blockstate.isFullCube(p_229092_2_, blockpos)) {
				VoxelShape voxelshape = blockstate.getOutlineShape(p_229092_2_, p_229092_3_.down());
				if (!voxelshape.isEmpty()) {
					...
					if (f >= 0.0F) {
						...
						Box axisalignedbb = voxelshape.getBoundingBox();
	...
	private static void shadowVertex(MatrixStack.Entry p_229091_0_, VertexConsumer p_229091_1_, float p_229091_2_,
