...
public class Backend {
    ...
    private static void onResourceManagerReload(ResourceManager manager, Predicate<IResourceType> predicate) {
    ...
    private static GlShader loadShader(ResourceManager manager, Identifier name, ShaderType type, GlShader.PreProcessor preProcessor) throws IOException {
