...
public abstract class StringSerializableTrigger<T> extends CriterionTriggerBase<StringSerializableTrigger.Instance<T>> {
	...
	@Override
	public com.simibubi.create.foundation.advancement.StringSerializableTrigger.Instance<T> conditionsFromJson(JsonObject json, AdvancementEntityPredicateDeserializer context) {
		if (json.has(getJsonKey())) {
			JsonArray elements = json.getAsJsonArray(getJsonKey());
			return new com.simibubi.create.foundation.advancement.StringSerializableTrigger.Instance<>(this,
