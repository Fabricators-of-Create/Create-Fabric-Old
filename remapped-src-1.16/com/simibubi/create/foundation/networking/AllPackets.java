...
public enum AllPackets {
	...
	private <T extends SimplePacketBase> AllPackets(Class<T> type, Function<PacketByteBuf, T> factory, NetworkDirection direction) {
	...
	private static class LoadedPacket<T extends SimplePacketBase> {
		...
		private LoadedPacket(Class<T> type, Function<PacketByteBuf, T> factory, NetworkDirection direction) {
			encoder = T::write;
			decoder = factory;
			handler = T::handle;
			this.type = type;
