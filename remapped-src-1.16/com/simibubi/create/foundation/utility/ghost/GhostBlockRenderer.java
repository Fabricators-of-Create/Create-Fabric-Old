...
public abstract class GhostBlockRenderer {
	...
	private static class DefaultGhostBlockRenderer extends GhostBlockRenderer {
		...
		public void render(MatrixStack ms, SuperRenderTypeBuffer buffer, GhostBlockParams params) {
			...
			dispatcher.getModelRenderer().renderModel(ms.peek(), vb, params.state, model, 1f, 1f, 1f, 0xF000F0, OverlayTexture.DEFAULT_UV, VirtualEmptyModelData.INSTANCE);
	...
	private static class TransparentGhostBlockRenderer extends GhostBlockRenderer {
		...
		//BlockModelRenderer
		public void renderModel(GhostBlockParams params, MatrixStack.Entry entry, VertexConsumer vb, @Nullable BlockState state, BakedModel model, float p_228804_5_, float p_228804_6_, float p_228804_7_, int p_228804_8_, int p_228804_9_, net.minecraftforge.client.model.data.IModelData modelData) {
