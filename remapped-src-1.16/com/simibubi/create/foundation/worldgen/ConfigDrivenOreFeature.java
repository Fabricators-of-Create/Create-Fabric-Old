...
public class ConfigDrivenOreFeature extends Feature<ConfigDrivenOreFeatureConfig> {
	...
	public boolean generate(StructureWorldAccess p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_,
		...
		for (int l1 = k; l1 <= k + j1; ++l1) {
			for (int i2 = i1; i2 <= i1 + j1; ++i2) {
				if (l <= p_241855_1_.getTopY(Heightmap.Type.OCEAN_FLOOR_WG, l1, i2)) {
	...
	protected boolean func_207803_a(WorldAccess p_207803_1_, Random p_207803_2_, ConfigDrivenOreFeatureConfig p_207803_3_,
